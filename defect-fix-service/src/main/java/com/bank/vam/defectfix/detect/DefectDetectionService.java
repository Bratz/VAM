...
public class DefectDetectionService {
    ...
    public void handleFailedPrRun(Stack stack, String baseSha, String headSha, String headBranch, int prNumber,
                                   int chainDepth) throws Exception {
        ...
        for (DetectedDefect defect : newDefects) {
            ticketService.fileIfNew(defect, prNumber, headBranch, chainDepth);
        }
