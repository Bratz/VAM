      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-neutral-50 rounded-lg p-4 text-center dark:bg-primary-950">
              <p className="text-sm text-neutral-500 mb-1 dark:text-neutral-400">Gross Volume</p>
            ...
            <div className="bg-primary-50 rounded-lg p-4 text-center dark:bg-primary-800/40">
              <p className="text-sm text-neutral-500 mb-1 dark:text-neutral-400">Net Volume</p>
              <p className="text-xl font-bold text-primary-700 dark:text-neutral-200">
                {formatCompactCurrency(cycle.totalNet || 0, cycle.baseCurrency)}
              </p>
            </div>
            <div className="bg-success-50 rounded-lg p-4 text-center dark:bg-success-500/10">
              <p className="text-sm text-neutral-500 mb-1 dark:text-neutral-400">Savings</p>
              <p className="text-xl font-bold text-success-700 dark:text-success-300">
                {formatCompactCurrency(cycle.savingsAmount || 0, cycle.baseCurrency)}
              </p>
            </div>
            <div className="bg-info-50 rounded-lg p-4 text-center dark:bg-info-500/10">
              <p className="text-sm text-neutral-500 mb-1 dark:text-neutral-400">Efficiency</p>
              <p className="text-xl font-bold text-info-700 dark:text-info-300">
                {cycle.savingsPercent?.toFixed(1) || 0}%
              </p>
            </div>
          </div>
