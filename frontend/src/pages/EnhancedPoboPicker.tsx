  ...
  return (
    <div className="bg-surface-card rounded-lg border border-edge p-3 space-y-2">
      ...
      {entity.pendingPobo && entity.pendingPobo > 0 && (
        <div className="flex items-center gap-1 caption-info">
  ...
  return (
    <Card className="bg-primary-50 border-primary-200 dark:bg-primary-800/40 dark:border-primary-700">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h4 className="body-strong font-semibold">IHB Intercompany Loan</h4>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between bg-surface-card rounded-lg p-3">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center">
                <p className="text-body-sm font-bold text-primary-900 dark:text-neutral-50">{formatCurrency(amount, currencyCode)}</p>
                <p className="text-caption text-primary-600 dark:text-primary-200">@ {interestRate}% p.a.</p>
              </div>
              <ArrowRight className="w-5 h-5 text-primary-500" />
              <div className="w-12 h-0.5 bg-primary-300" />
            </div>
          ...
          <div className="text-center">
            ...
            <p className="caption">Borrower</p>
          </div>
        </div>
                  ...
                  {payingEntity ? (
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-left">
                        <span className="body-strong">{payingEntity.entityName}</span>
                        <span className="caption ml-2">({payingEntity.entityCode})</span>
                      </div>
                    </div>
                  ) : (
