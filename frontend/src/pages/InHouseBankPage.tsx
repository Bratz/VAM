...
const programTypeConfig: Record<string, { label: string; color: string }> = {
  ...
  IHB: { label: 'In-House Bank', color: 'text-purple-600 dark:text-purple-300' },
  ...
  ESCROW: { label: 'Escrow', color: 'text-teal-600 dark:text-teal-300' },
};
...
const EntityCard: React.FC<{
  ...
  return (
    <Card hover className={cn(
      isTreasuryCenter && 'ring-2 ring-amber-200 bg-gradient-to-br from-amber-50/50 to-white'
    )}>
      <div className="p-4">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={cn(
              ...
              isTreasuryCenter ? 'bg-amber-100 dark:bg-amber-500/20' : isPositive ? 'bg-success-100 dark:bg-success-500/20' : 'bg-error-100 dark:bg-error-500/20'
            )}>
              {isTreasuryCenter ? (
                <Building2 className="w-5 h-5 text-amber-600 dark:text-amber-300" />
              ) : isPositive ? (
          ...
          <div className="flex flex-col items-end gap-1">
            {isTreasuryCenter && (
              <Badge variant="warning" size="sm" className="bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-500/20 dark:text-amber-300 dark:border-amber-500/30">
                Treasury Center
              </Badge>
            )}
            {isDualRole && (
        ...
        <div className="space-y-3">
          ...
          {isTreasuryCenter ? (
            <>
              ...
              <div className="bg-amber-50 rounded-lg p-3 border border-amber-100 dark:bg-amber-500/10 dark:border-amber-500/30">
                <p className="text-xs font-semibold text-amber-700 uppercase tracking-wide mb-2 dark:text-amber-300">Lending Portfolio</p>
                <div className="flex justify-between items-baseline">
                  <span className="text-xs text-amber-600 dark:text-amber-300">Total Lent Out</span>
                  <span className="text-lg font-bold text-amber-900">{formatCurrency(totalLentOut, currency)}</span>
                </div>
                <div className="flex justify-between items-baseline mt-1">
                  <span className="text-xs text-amber-600 dark:text-amber-300">Deposits Received</span>
                  <span className="text-sm font-semibold text-amber-800 dark:text-amber-300">{formatCurrency(totalDeposited, currency)}</span>
                </div>
              </div>
        ...
        <div className="flex flex-wrap gap-2 mt-4 pt-3 border-t border-neutral-200 dark:border-primary-800">
          ...
          {isTreasuryCenter && onCreateLoan && (
            <Button variant="ghost" size="sm" className="flex-1 text-amber-600 hover:bg-amber-50 dark:text-amber-300 dark:hover:bg-amber-500/10" onClick={onCreateLoan}>
          ...
          {isParticipant && onCreateCurrentAccount && !entity.settlementVaId && (
            <Button variant="ghost" size="sm" className="flex-1 text-purple-600 hover:bg-purple-50 dark:text-purple-300 dark:hover:bg-purple-500/10" onClick={onCreateCurrentAccount}>
    ...
    () => (
      <>
        ...
        <Button
          ...
          className="text-purple-600 border-purple-200 hover:bg-purple-50 dark:text-purple-300 dark:border-purple-500/30 dark:hover:bg-purple-500/10"
        >
          Current Account
        </Button>
      </>
    ...
    <Page>
      ...
      {!selectedCorporateId && (
        <Card padding="md" className="bg-gradient-to-r from-neutral-50 via-white to-neutral-50 border-neutral-200 animate-fade-in dark:border-primary-800 dark:from-primary-900 dark:via-primary-900 dark:to-primary-900" style={{ animationDelay: '0.15s' }}>
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <div className="w-16 h-16 rounded-2xl bg-amber-100 flex items-center justify-center mb-4 dark:bg-amber-500/20">
      ...
      {selectedCorporateId && (
        <>
          ...
          {treasuryRates && (
            <Card padding="sm" className="bg-gradient-to-r from-amber-50/50 via-white to-success-50/50 border-amber-200/60 animate-fade-in" style={{ animationDelay: '0.15s' }}>
              <div className="flex items-center justify-between p-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-amber-100 flex items-center justify-center flex-shrink-0 dark:bg-amber-500/20">
                    <TrendingUp className="w-5 h-5 text-amber-600 dark:text-amber-300" />
                  </div>
                  <div>
                    <p className="text-xs font-medium text-amber-700 uppercase tracking-wide dark:text-amber-300">Treasury Indicative Rates</p>
                    <p className="text-sm text-neutral-700 mt-0.5 dark:text-neutral-200">
                      <span className="font-semibold text-amber-800 dark:text-amber-300">Lending: {treasuryRates.indicativeLendingRate?.toFixed(2) || 'N/A'}%</span>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              {settlementStatus && (settlementStatus.committedDeposits > 0 || settlementStatus.committedLoans > 0 || settlementStatus.pendingApproval > 0) && (
                <Card className="bg-gradient-to-r from-info-50 to-purple-50 border-info-200 dark:border-info-500/30 dark:from-info-500/15 dark:to-purple-500/15">
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {settlementStatus.pendingApproval > 0 && (
                        <div className="bg-warning-100 rounded-lg p-3 dark:bg-warning-500/20">
                          ...
                          <p className="text-xl font-bold text-warning-900">{settlementStatus.pendingApproval}</p>
                      ...
                      <div className="bg-info-100 rounded-lg p-3 dark:bg-info-500/20">
                        ...
                        <p className="text-xl font-bold text-info-900">{settlementStatus.committedDeposits}</p>
                        <p className="text-xs text-info-600 dark:text-info-300">{formatCurrency(settlementStatus.totalCommittedDeposits, 'AED')}</p>
                      </div>
                      <div className="bg-purple-100 rounded-lg p-3 dark:bg-purple-500/20">
                        <p className="text-xs font-medium text-purple-700 dark:text-purple-300">Committed Loans</p>
                        <p className="text-xl font-bold text-purple-900">{settlementStatus.committedLoans}</p>
                        <p className="text-xs text-purple-600 dark:text-purple-300">{formatCurrency(settlementStatus.totalCommittedLoans, 'AED')}</p>
                      </div>
              ...
              {currentAccounts.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {currentAccounts.map(account => (
                    <Card key={account.accountId} hover className="border-purple-100 dark:border-purple-500/30">
                      <div className="p-4">
                        {/* Account Header */}
                        ...
                        <div className="flex gap-2 mb-3">
                          <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-300">
      ...
      >
        <div className="space-y-5">
          ...
          {treasuryRates && (
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 dark:border-amber-500/30 dark:bg-amber-500/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-amber-700 uppercase tracking-wide dark:text-amber-300">Treasury Indicative Lending Rate</p>
                  <p className="stat-value text-amber-900">{treasuryRates.indicativeLendingRate?.toFixed(2) || 'N/A'}%</p>
                ...
                <div className="text-right text-xs text-amber-600 dark:text-amber-300">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              {treasuryRates && (
                <Button variant="ghost" size="sm" onClick={fillLoanRateFromTreasury} className="text-xs text-amber-600 hover:text-amber-700 dark:text-amber-300">
          ...
          <div className="space-y-5">
            ...
            <div className={cn(
              ...
              selectedEntity.canLend && !selectedEntity.canBorrow
                ? "bg-amber-50 border-amber-200 dark:border-amber-500/30 dark:bg-amber-500/10"
                : "bg-primary-50 border-primary-200 dark:border-primary-700 dark:bg-primary-500/10"
            )}>
              <div className="flex items-center gap-3 mb-3">
                <div className={cn(
                  "w-10 h-10 rounded-xl flex items-center justify-center",
                  selectedEntity.canLend && !selectedEntity.canBorrow ? "bg-amber-100 dark:bg-amber-500/20" : "bg-primary-100 dark:bg-primary-700"
                )}>
                  <Building2 className={cn(
                    "w-5 h-5",
                    selectedEntity.canLend && !selectedEntity.canBorrow ? "text-amber-600 dark:text-amber-300" : "text-primary-600 dark:text-primary-200"
                  )} />
                </div>
                <div>
      ...
      >
        <div className="space-y-5">
          {/* Description */}
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 dark:border-purple-500/30 dark:bg-purple-500/10">
            <div className="flex items-start gap-3">
          ...
          {treasuryRates && (
            <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 dark:bg-primary-950 dark:border-primary-800">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" onClick={fillCurrentAccountRatesFromTreasury} className="text-xs text-purple-600 dark:text-purple-300">
