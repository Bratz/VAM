...
const PoboBadge: React.FC<{ eligible?: boolean; defaultPayerCode?: string }> = ({ eligible, defaultPayerCode }) => {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-info-50 to-indigo-50 text-indigo-700 border border-indigo-200 dark:text-indigo-300 dark:border-indigo-500/30 dark:from-info-500/15 dark:to-indigo-500/15">
      <Wallet className="w-3 h-3" />
      POBO
      {defaultPayerCode && <span className="text-indigo-500 font-normal">→ {defaultPayerCode}</span>}
    </span>
  );
};
...
const IntercompanyBadge: React.FC<{ isIntercompany?: boolean; linkedEntityCode?: string; settlementMethod?: IcSettlementMethod }> = 
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 border border-purple-200 dark:text-purple-300 dark:border-purple-500/30 dark:from-purple-500/15 dark:to-pink-500/15">
      <Link2 className="w-3 h-3" />
      IC
      {linkedEntityCode && <span className="text-purple-500 font-normal">↔ {linkedEntityCode}</span>}
...
const NettingBadge: React.FC<{ eligible?: boolean }> = ({ eligible }) => {
  if (!eligible) return null;
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-emerald-50 to-teal-50 text-teal-700 border border-teal-200 dark:text-teal-300 dark:border-teal-500/30 dark:from-emerald-500/15 dark:to-teal-500/15">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg border border-purple-200 dark:bg-purple-500/10 dark:border-purple-500/30">
                    <div className="p-2 bg-purple-100 rounded-lg dark:bg-purple-500/20">
                      <Link2 className="w-5 h-5 text-purple-600 dark:text-purple-300" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-medium text-purple-900">Intercompany Party</h4>
                          <p className="text-sm text-purple-700 dark:text-purple-300">This party represents another legal entity within the group</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            ...
                            className="sr-only peer"
                          />
                          <div className="w-11 h-6 bg-neutral-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-neutral-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600 dark:bg-primary-800"></div>
                        </label>
                      </div>
                    </div>
                  </div>

                  <div className="flex items-start gap-4 p-4 bg-teal-50 rounded-lg border border-teal-200 dark:bg-teal-500/10 dark:border-teal-500/30">
                    <div className="p-2 bg-teal-100 rounded-lg dark:bg-teal-500/20">
                      <Repeat className="w-5 h-5 text-teal-600 dark:text-teal-300" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-medium text-teal-900">Netting Eligible</h4>
                          <p className="text-sm text-teal-700 dark:text-teal-300">Include transactions in netting cycles for settlement optimization</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            ...
                            className="sr-only peer"
                          />
                          <div className="w-11 h-6 bg-neutral-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-teal-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-neutral-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600 dark:bg-primary-800"></div>
                        </label>
                      </div>
                    </div>
                  </div>
        ...
        <div className="flex items-start justify-between pb-4 border-b border-neutral-200 dark:border-primary-800">
          <div className="flex items-center gap-4">
            <div className={cn('w-14 h-14 rounded-xl flex items-center justify-center',
              party.isIntercompany ? 'bg-purple-100 dark:bg-purple-500/20' : party.status === 'ACTIVE' ? 'bg-primary-100 dark:bg-primary-700' : 'bg-error-100 dark:bg-error-500/20')}>
              <TypeIcon className={cn('w-7 h-7', party.isIntercompany ? 'text-purple-700 dark:text-purple-300' : party.status === 'ACTIVE' ? 'text-primary-700 dark:text-neutral-200' : 'text-error-600 dark:text-error-300')} />
            </div>
            <div>
              <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <Card padding="md" className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg dark:bg-indigo-500/10">
                    <div className="flex items-center gap-3">
                      <Wallet className="w-6 h-6 text-indigo-600 dark:text-indigo-300" />
                      <div><p className="text-sm font-medium text-indigo-900">POBO Enabled</p><p className="text-xs text-indigo-600 dark:text-indigo-300">Treasury can pay on behalf of subsidiaries</p></div>
                    </div>
              ...
              <div className="space-y-4">
                ...
                <Card padding="md">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-sm font-semibold text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300">2</div><div><p className="text-sm font-medium">Treasury pays vendor</p><p className="text-xs text-neutral-500 dark:text-neutral-400">{party.poboDefaultPayerEntityCode} → {party.displayName}</p></div></div>
                    <div className="ml-4 border-l-2 border-dashed border-neutral-200 h-6 dark:border-primary-800"></div>
                    <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-sm font-semibold text-purple-700 dark:bg-purple-500/20 dark:text-purple-300">3</div><div><p className="text-sm font-medium">IC Recharge created</p><p className="text-xs text-neutral-500 dark:text-neutral-400">{party.owningEntityCode} owes {party.poboDefaultPayerEntityCode}</p></div></div>
                  </div>
                </Card>
              </div>
            </div>
          ...
          {!loading && activeTab === 'intercompany' && (
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <Card padding="md" className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg dark:bg-purple-500/10">
                    <div className="flex items-center gap-3">
                      <Link2 className="w-6 h-6 text-purple-600 dark:text-purple-300" />
                      <div><p className="text-sm font-medium text-purple-900">Intercompany Party</p><p className="text-xs text-purple-600 dark:text-purple-300">Represents a group entity</p></div>
                    </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              ...
              return (
                <div key={tab.id} onClick={() => setRoleFilter(tab.id)} className="cursor-pointer">
                  ...
                  >
                    ...
                    <p className="text-xl font-semibold text-primary-900 mt-1 dark:text-neutral-50">{tab.count}</p>
                  </Card>
                </div>
              );
            })}
            <div onClick={() => setPoboFilter(!poboFilter)} className="cursor-pointer">
              <Card
                ...
                hover
                className={cn(
                  'transition-all animate-fade-in bg-gradient-to-br from-indigo-50 to-info-50 dark:from-indigo-500/10 dark:to-info-500/10',
                  poboFilter && 'ring-2 ring-primary-500 dark:ring-accent-400'
                )}
                style={{ animationDelay: '0.24s' }}
              >
                <div className="flex items-center gap-2"><Wallet className="w-4 h-4 text-indigo-600 dark:text-indigo-300" /><span className="text-xs text-indigo-600 dark:text-indigo-300">POBO Ready</span></div>
                <p className="text-xl font-semibold text-indigo-700 mt-1 dark:text-indigo-300">{displayStats.poboEligibleVendors}</p>
              </Card>
            </div>
            <div onClick={() => setIcFilter(!icFilter)} className="cursor-pointer">
              <Card
                ...
                hover
                className={cn(
                  'transition-all animate-fade-in bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-500/10 dark:to-pink-500/10',
                  icFilter && 'ring-2 ring-primary-500 dark:ring-accent-400'
                )}
                style={{ animationDelay: '0.27s' }}
              >
                <div className="flex items-center gap-2"><Link2 className="w-4 h-4 text-purple-600 dark:text-purple-300" /><span className="text-xs text-purple-600 dark:text-purple-300">Intercompany</span></div>
                <p className="text-xl font-semibold text-purple-700 mt-1 dark:text-purple-300">{displayStats.intercompanyParties}</p>
              </Card>
            </div>
            <div onClick={() => setNettingFilter(!nettingFilter)} className="cursor-pointer">
              <Card
                ...
                hover
                className={cn(
                  'transition-all animate-fade-in bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-500/10 dark:to-emerald-500/10',
                  nettingFilter && 'ring-2 ring-primary-500 dark:ring-accent-400'
                )}
                style={{ animationDelay: '0.3s' }}
              >
                <div className="flex items-center gap-2"><Repeat className="w-4 h-4 text-teal-600 dark:text-teal-300" /><span className="text-xs text-teal-600 dark:text-teal-300">Netting</span></div>
                <p className="text-xl font-semibold text-teal-700 mt-1 dark:text-teal-300">{displayStats.nettingEligibleParties}</p>
              </Card>
            </div>
          </div>
                    ...
                    return (
                      <tr key={party.id} className="data-table-row group cursor-pointer" onClick={() => setSelectedParty(party)}>
                        <td className="data-table-cell">
                          <div className="flex items-center gap-3">
                            <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center transition-transform group-hover:scale-105', party.isIntercompany ? 'bg-purple-100 dark:bg-purple-500/20' : party.status === 'ACTIVE' ? 'bg-primary-100 dark:bg-primary-700' : 'bg-error-100 dark:bg-error-500/20')}>
                              <TypeIcon className={cn('w-5 h-5', party.isIntercompany ? 'text-purple-700 dark:text-purple-300' : party.status === 'ACTIVE' ? 'text-primary-700 dark:text-neutral-200' : 'text-error-600 dark:text-error-300')} />
                            </div>
