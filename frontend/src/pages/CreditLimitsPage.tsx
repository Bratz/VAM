...
const formatCurrency = (amount: number | undefined | null, currency: string = 'AED'): string => {
        ...
        {currencies.map(currency => {
          ...
          return (
            ...
            >
              ...
              <span className="text-neutral-600 dark:text-neutral-300" title={formatCurrency(limit?.limitAmount, currency)}>{formatCompactAmount(limit?.limitAmount)}</span>
            ...
            <div className="bg-primary-50 rounded-lg p-4 mb-6 dark:bg-primary-800/40">
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xl font-bold text-success-700 dark:text-success-300">{formatCurrency(entityUnallocated, currency)}</p>
                </div>
              </div>
            </div>
          )}
                      ...
                      return (
                        <div key={va.id} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg border border-neutral-200 dark:bg-primary-950 dark:border-primary-800">
                          ...
                          <div className="text-right mr-4">
                            <p className="font-bold text-neutral-900 dark:text-neutral-50">{formatCurrency(limit?.limitAmount, currency)}</p>
