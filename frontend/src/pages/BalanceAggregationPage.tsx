...
const NODE_TYPE_CONFIG: Record<string, { label: string; icon: any; color: string; bgColor: string }> = {
  ROOT: { label: 'Root', icon: Building2, color: 'text-purple-700 dark:text-purple-300', bgColor: 'bg-purple-100 dark:bg-purple-500/20' },
  ...
  LEGAL_ENTITY: { label: 'Legal Entity', icon: Building2, color: 'text-amber-700 dark:text-amber-300', bgColor: 'bg-amber-100 dark:bg-amber-500/20' },
  BUSINESS_UNIT: { label: 'Business Unit', icon: Briefcase, color: 'text-teal-700 dark:text-teal-300', bgColor: 'bg-teal-100 dark:bg-teal-500/20' },
  DEPARTMENT: { label: 'Department', icon: Briefcase, color: 'text-indigo-700 dark:text-indigo-300', bgColor: 'bg-indigo-100 dark:bg-indigo-500/20' },
  VIRTUAL_ACCOUNT: { label: 'Virtual Account', icon: Wallet, color: 'text-pink-700 dark:text-pink-300', bgColor: 'bg-pink-100 dark:bg-pink-500/20' },
};
