...
const programTypeConfig: Record<string, { label: string; icon: React.ElementType; color: string; bgColor: string; description: string }> = {
  ...
  LOYALTY: { label: 'Loyalty', icon: TrendingUp, color: 'text-pink-600 dark:text-pink-300', bgColor: 'bg-pink-50 dark:bg-pink-500/10', description: 'Loyalty/rewards program' },
  GIFT_CARD: { label: 'Gift Card', icon: Gift, color: 'text-purple-600 dark:text-purple-300', bgColor: 'bg-purple-50 dark:bg-purple-500/10', description: 'Gift card program' },
  CORPORATE_CARD: { label: 'Corporate Card', icon: CreditCard, color: 'text-indigo-600 dark:text-indigo-300', bgColor: 'bg-indigo-50 dark:bg-indigo-500/10', description: 'Corporate card program' },
  MOBILE_MONEY: { label: 'Mobile Money', icon: Smartphone, color: 'text-teal-600 dark:text-teal-300', bgColor: 'bg-teal-50 dark:bg-teal-500/10', description: 'Mobile money/agent banking' },
};
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { key: 'hierarchyEnabled', label: 'Multi-Level Hierarchy', icon: GitBranch, desc: 'Organize VAs in 7-level tree structure', color: 'text-purple-600 dark:text-purple-300', step: 'Hierarchy Config' },
            ...
            {['LOYALTY', 'GIFT_CARD', 'CORPORATE_CARD', 'MOBILE_MONEY'].includes(formData.programType) && (
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { key: 'loyaltyEnabled', label: 'Loyalty Program', icon: TrendingUp, desc: 'Points, tiers, rewards', color: 'text-pink-600 dark:text-pink-300', forType: 'LOYALTY' },
                    { key: 'giftCardEnabled', label: 'Gift Cards', icon: Gift, desc: 'Gift card issuance', color: 'text-purple-600 dark:text-purple-300', forType: 'GIFT_CARD' },
                    { key: 'corporateCardEnabled', label: 'Corporate Cards', icon: CreditCard, desc: 'Expense cards, limits', color: 'text-indigo-600 dark:text-indigo-300', forType: 'CORPORATE_CARD' },
                    { key: 'mobileMoneyEnabled', label: 'Mobile Money', icon: Smartphone, desc: 'Agent banking, M-Pesa style', color: 'text-teal-600 dark:text-teal-300', forType: 'MOBILE_MONEY' },
            ...
            {formData.hierarchyEnabled && (
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 flex items-start gap-2 dark:bg-purple-500/10 dark:border-purple-500/30">
                <GitBranch className="w-4 h-4 text-purple-600 mt-0.5 dark:text-purple-300" />
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                isSelected ? 'border-purple-500 bg-purple-50 ring-2 ring-purple-500 dark:bg-purple-500/10' : 'border-neutral-200 hover:border-neutral-300 dark:border-primary-800 dark:hover:border-primary-700'
                              )}
                            >
                              {isRecommended && (
                              ...
                              <div className="flex items-center gap-2 mb-2">
                                <Icon className={cn('w-5 h-5', isSelected ? 'text-purple-600 dark:text-purple-300' : template.color)} />
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {otherTemplates.map(template => {
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-2">
                                <Icon className={cn('w-4 h-4', isSelected ? 'text-purple-600 dark:text-purple-300' : 'text-neutral-400 dark:text-neutral-500')} />
              ...
              <div className="bg-neutral-50 rounded-lg p-4 dark:bg-primary-950">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-xs text-purple-600 hover:text-purple-700 flex items-center gap-1 dark:text-purple-300"
                  >
                  ...
                  {hierarchyLevelConfigs.slice(0, formData.hierarchyDepth).map((level, idx) => {
                    ...
                    return (
                      <div key={idx} className={cn(
                        ...
                        isExpanded ? 'border-purple-300 bg-white dark:bg-primary-900' : 'border-neutral-200 bg-neutral-50 dark:border-primary-800 dark:bg-primary-950'
                      )}>
                        ...
                        >
                          <span className={cn(
                            ...
                            isRoot ? 'bg-purple-500 text-white' :
                          ...
                          {level.allowedValues && level.allowedValues.length > 0 && (
                            <span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full dark:bg-purple-500/20 dark:text-purple-300">
                          ...
                          <div className="px-3 pb-3 border-t border-neutral-200 pt-3 space-y-3 dark:border-primary-800">
                                  ...
                                  if (suggestedForType) {
                                    return (
                                      <button
                                        ...
                                        className="text-xs text-purple-600 hover:text-purple-700 dark:text-purple-300"
                                      >
                                        + Add suggested
                                      </button>
                                    );
                              ...
                              <div className="flex flex-wrap gap-1 mb-2 min-h-[28px]">
                                {level.allowedValues && level.allowedValues.length > 0 ? (
                                  level.allowedValues.map((value, vIdx) => (
                                    <span
                                      key={vIdx}
                                      className="inline-flex items-center gap-1 px-2 py-0.5 bg-purple-100 text-purple-700 text-xs rounded-full dark:bg-purple-500/20 dark:text-purple-300"
                                    >
                                      {value}
                                      <button
                                        type="button"
                            ...
                            <label className="flex items-center gap-2 text-xs">
                              <input
                                ...
                                className="rounded text-purple-600 dark:text-purple-300"
                              />
