...
import { Card, Button, Badge, Skeleton, StatusIconBadge } from '../components/ui';
  ...
  <Card padding="sm" className="animate-fade-in" style={delay ? { animationDelay: delay } : undefined}>
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">{title}</p>
      </div>
    </div>
  </Card>
);
    ...
    <Page>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <StatCard
          ...
          icon={<Layers className="w-5 h-5 text-primary-600 dark:text-primary-200" />}
        ...
        <StatCard
          ...
          icon={<TrendingUp className="w-5 h-5 text-success-600 dark:text-success-300" />}
        ...
        <StatCard
          ...
          icon={<DollarSign className="w-5 h-5 text-info-600 dark:text-info-300" />}
        ...
        <StatCard
          ...
          icon={<PiggyBank className="w-5 h-5 text-warning-600 dark:text-warning-300" />}
        ...
        <StatCard
          ...
          icon={<Users className="w-5 h-5 text-accent-600 dark:text-accent-300" />}
