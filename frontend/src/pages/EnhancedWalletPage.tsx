        ...
        {walletDetail ? (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Card padding="sm" className="bg-success-50 dark:bg-success-500/10"><p className="text-xs text-neutral-500 dark:text-neutral-400">Available Balance</p><p className="text-xl font-semibold text-success-600 dark:text-success-300">{formatCurrency(walletDetail.availableBalance)}</p></Card>
              <Card padding="sm" className="bg-neutral-50 dark:bg-primary-950"><p className="text-xs text-neutral-500 dark:text-neutral-400">Monthly Spent</p><p className="text-xl font-semibold text-neutral-700 dark:text-neutral-200">{formatCurrency(walletDetail.monthlySpent || 0)}</p></Card>
            </div>
