...
const formatCurrency = (amount: number | undefined | null, currency = 'AED'): string => {
...
const TreasurySummaryCard: React.FC<{
  ...
  const items = [
    ...
    {
      icon: <PiggyBank className="w-5 h-5 text-purple-600 dark:text-purple-300" />,
    ...
    {
      icon: <Landmark className="w-5 h-5 text-amber-600 dark:text-amber-300" />,
      label: 'IHB Loans',
      ...
      <div className="grid grid-cols-2 gap-4">
        {items.map((item, index) => (
          ...
          >
            ...
            <p className="text-xl font-bold text-neutral-900 dark:text-neutral-50">{item.value}</p>
...
const AlertsCard: React.FC<{
  ...
  const getAlertIcon = (type: string) => {
    switch (type) {
      case 'WARNING':
        return <AlertTriangle className="w-4 h-4 text-amber-600 dark:text-amber-300" />;
      case 'ERROR':
...
const QuickActions: React.FC<{
  ...
  const actions = [
    ...
    { icon: <CreditCard className="w-5 h-5" />, label: 'Payables (AP)', page: 'payables', color: 'text-purple-600 dark:text-purple-300', bg: 'bg-purple-50 hover:bg-purple-100 dark:bg-purple-500/10 dark:hover:bg-purple-500/20' },
    ...
    { icon: <Landmark className="w-5 h-5" />, label: 'In-House Bank', page: 'ihb', color: 'text-amber-600 dark:text-amber-300', bg: 'bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/10 dark:hover:bg-amber-500/20' },
    ...
    { icon: <Users className="w-5 h-5" />, label: 'Legal Entities', page: 'legal-entities', color: 'text-teal-600 dark:text-teal-300', bg: 'bg-teal-50 hover:bg-teal-100 dark:bg-teal-500/10 dark:hover:bg-teal-500/20' },
    { icon: <Briefcase className="w-5 h-5" />, label: 'Programs', page: 'programs', color: 'text-indigo-600 dark:text-indigo-300', bg: 'bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-500/10 dark:hover:bg-indigo-500/20' },
  ];
