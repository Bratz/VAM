...
const COLLECTION_CHANNELS = [
  { value: 'BANK_TRANSFER', label: 'Bank Transfer', icon: '🏦', description: 'Wire transfers and ACH' },
  { value: 'CARD', label: 'Card Payment', icon: '💳', description: 'Credit/Debit card payments' },
  { value: 'MOBILE', label: 'Mobile Money', icon: '📱', description: 'Mobile wallet payments' },
  { value: 'CASH', label: 'Cash', icon: '💵', description: 'Cash deposits at branches/agents' },
  { value: 'CHEQUE', label: 'Cheque', icon: '📝', description: 'Cheque deposits' },
  { value: 'DIRECT_DEBIT', label: 'Direct Debit', icon: '🔄', description: 'Automatic collections' },
  { value: 'WALLET', label: 'Wallet Transfer', icon: '👛', description: 'Internal wallet transfers' },
];
...
const HierarchyNodeItem: React.FC<HierarchyNodeItemProps> = ({
  ...
  const nodeTypeConfig = {
    ...
    CONSOLIDATION: { icon: Layers, color: 'text-purple-600', bg: 'bg-purple-100' },
