...
const DIMENSION_TYPES = [
  { value: 'CURRENCY', label: 'Currency', description: 'Currency code (AED, USD, EUR)', icon: '💱' },
  { value: 'REGION', label: 'Region', description: 'Geographic region', icon: '🌍' },
  { value: 'COUNTRY', label: 'Country', description: 'Country code', icon: '🏳️' },
  { value: 'STATE', label: 'State/Province', description: 'State or province', icon: '📍' },
  { value: 'CITY', label: 'City', description: 'City name', icon: '🏙️' },
  { value: 'ENTITY', label: 'Legal Entity', description: 'Legal entity code', icon: '🏢' },
  { value: 'DEPARTMENT', label: 'Department', description: 'Department or division', icon: '👥' },
  { value: 'COST_CENTER', label: 'Cost Center', description: 'Cost center code', icon: '💰' },
  { value: 'ACCOUNT_TYPE', label: 'Account Type', description: 'Account classification', icon: '📊' },
  { value: 'CHANNEL', label: 'Channel', description: 'Collection/payment channel', icon: '📡' },
  { value: 'PLATFORM', label: 'Platform', description: 'Platform or gateway', icon: '🌐' },
  { value: 'SEGMENT', label: 'Segment', description: 'Customer segment', icon: '🎯' },
  { value: 'CUSTOMER', label: 'Customer', description: 'Customer identifier', icon: '👤' },
  { value: 'MERCHANT', label: 'Merchant', description: 'Merchant identifier', icon: '🏪' },
  { value: 'PARTNER', label: 'Partner', description: 'Partner identifier', icon: '🤝' },
  { value: 'TIER', label: 'Tier', description: 'Customer tier level', icon: '⭐' },
  { value: 'BUDGET_OWNER', label: 'Budget Owner', description: 'Budget owner', icon: '📋' },
  { value: 'VIRTUAL_ACCOUNT', label: 'Virtual Account', description: 'Leaf level VA', icon: '💳' },
];
...
export const HierarchyLevelConfigModal: React.FC<HierarchyLevelConfigModalProps> = ({
  ...
  const handleAddLevel = () => {
    if (levels.length >= 7) return; // Maximum 7 levels
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-neutral-700 dark:text-neutral-200">
              Hierarchy Levels ({levels.length}/7)
            </h3>
            {levels.length < 7 && (
