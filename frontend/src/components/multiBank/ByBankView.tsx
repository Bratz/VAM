                    ...
                    <tbody>
                      {ccy.shadows.map((s) => (
                        ...
                        <tr key={s.vaId} className="border-t border-neutral-100 dark:border-primary-800/60 hover:bg-neutral-50 dark:hover:bg-primary-800/40 text-neutral-700 dark:text-neutral-200">
                          ...
                          <td className="py-2.5 font-mono text-right">{formatCurrency(s.bankBalance, s.currencyCode)}</td>
          ...
          <div className="flex flex-wrap gap-2">
            {currencyTotals.map(({ code, effective }) => (
              ...
              >
                ...
                <span className="font-mono text-neutral-900 dark:text-neutral-50">{formatCurrency(effective, code)}</span>
              </span>
            ))}
          </div>
        </div>
