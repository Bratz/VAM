...
| J3 | Dashboard | Treasury-2030 dashboard: consolidated position, payments to approve/pay, accounts, sweeps | ● | `DashboardController` (`/pending-approvals`) · `Treasury2030DashboardPage` |
